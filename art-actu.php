...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .legend .item { display: inline-flex; align-items: center; gap: 6px; color: #F4F1EB; background: #1A1916; border: 1.5px solid #34322C; border-radius: 20px; padding: 3px 10px 3px 3px; font: inherit; text-decoration: none; cursor: pointer; transition: opacity .15s, border-color .15s, background .15s; }
...
<?php endforeach; ?>
  ...
  <a href="/art-actu-proposer.php" class="item item-action" id="add-event-link">+ Proposer un événement</a>
</div>
